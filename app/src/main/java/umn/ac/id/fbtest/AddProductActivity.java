...
public class AddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        AddNewProductButton = (Button) findViewById(R.id.btnAddprod);
        InputProductImage = (ImageView) findViewById(R.id.imvAdd);
        InputProductName = (EditText) findViewById(R.id.etAddNama);
        InputProductDescription = (EditText) findViewById(R.id.etAddDetail);
        InputProductPrice = (EditText) findViewById(R.id.etAddHarga);
    ...
    private void StoreProductInformation()
    {
        ...
        final StorageReference filePath = ProductImagesRef.child(Company).child(ImageUri.getLastPathSegment() + productRandomKey + ".jpg");
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        ProductsRef.child(Company).child(productRandomKey).updateChildren(productMap)
